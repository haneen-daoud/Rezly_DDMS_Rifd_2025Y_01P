  ...
  return (
    <div className="flex flex-col gap-3 flex-1 w-full">
      ...
      <div className="flex justify-between items-center p-2">
        ...
        <div className="flex flex-2 items-center gap-3">
          ...
          <div className="flex items-center gap-1 cursor-pointer text-gray-700 hover:text-gray-900">
            ...
            <span className="text-[12px] font-[600] font-Cairo leading-[150%]">فلترة حسب</span>
          </div>
        ...
        <div className="flex justify-end align-center">
          <div className="iconbox flex justify-between gap-2">
            <div
              ...
              className={`cursor-pointer p-2 border-b border-gray-5 rounded-md transition-colors
      ...
      2.05228 19.5523 2.5 19 2.5H1C0.447715 2.5 0 2.05228 0 1.5C0 0.947715 0.447715 0.5 1 0.5H19Z"
            ...
            <div className=" flex w-50 justify-between gap-2 px-2 py-1 align-center   bg-white">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* صححت هنا clip-path إلى clipPath */}
                <g clipPath="url(#clip0_1569_57)">
                  <path d="M6.33301 0.666992C9.46251 0.666992 11.9998 3.20354 12 6.33301C12 7.65733 11.5435 8.8741 10.7822 9.83887L11.8047 10.8623L11.7793 10.8867C12.2287 10.754 12.7352 10.866 13.0898 11.2207L14.7793 12.9102C15.2955 13.4263 15.2955 14.2631 14.7793 14.7793C14.2631 15.2955 13.4263 15.2955 12.9102 14.7793L11.2207 13.0898C10.866 12.7352 10.754 12.2287 10.8867 11.7793L10.8623 11.8047L9.83887 10.7822C8.8741 11.5435 7.65733 12 6.33301 12C3.20354 11.9998 0.666992 9.46251 0.666992 6.33301C0.667168 3.20365 3.20365 0.667168 6.33301 0.666992ZM6.33301 2C3.94003 2.00018 2.00018 3.94003 2 6.33301C2 8.72613 3.93992 10.6668 6.33301 10.667C8.72624 10.667 10.667 8.72624 10.667 6.33301C10.6668 3.93992 8.72613 2 6.33301 2Z" fill="#fff" />
                </g>
                <defs>
