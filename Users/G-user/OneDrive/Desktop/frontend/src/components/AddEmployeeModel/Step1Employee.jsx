        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full p-2.5 pr-10 border placeholder-[color:var(--grey,#7E818C)] border-gray-300 rounded-xl text-[12px] focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
            <svg
              width="17"
              height="16"
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-[var(--color-purple)] rounded-xl p-5 text-center text-gray-500 text-[12px] cursor-pointer hover:border-purple-400 transition">
            ...
            <label htmlFor="imageUpload" className="cursor-pointer">
              ...
              {data.image && <p className="text-green-600 mt-2">✔ تم اختيار الملف</p>}
            </label>
          </div>
        </div>
      </form>
