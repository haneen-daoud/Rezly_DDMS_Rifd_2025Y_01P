                   ...
                   <div className="flex flex-col gap-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-2.5 py-3 border border-gray-300 rounded-xl text-[12px] placeholder-[color:var(--grey,#7E818C)] focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                    ...
                    <select
                        className="w-full border border-gray-300 rounded-xl px-2.5 py-3 text-[12px] text-[color:var(--grey,#7E818C)] focus:outline-none focus:ring-2 focus:ring-purple-600"
                    >
