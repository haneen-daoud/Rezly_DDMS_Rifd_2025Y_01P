...
const Step4Participant = forwardRef(
  ({ memberData, setMemberData, packages = [] }, ref) => {
        ...
        <form className="w-[343px] flex flex-col gap-3 font-[Cairo]">
            ...
            <Select
              ...
              value={
                packageOptions.find(
                  (opt) =>
                    opt.value ===
                    (selectedPackage?._id || memberData.packageId || "")
                ) || null
              }
              onChange={(opt) => handlePackageChange(opt ? opt.value : "")}
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              readOnly
              className="w-full h-[42px] border border-gray-300 rounded-[8px] p-3 text-[12px] text-gray-500 bg-gray-100 cursor-not-allowed"
            />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <Select
              ...
              onChange={(opt) =>
                handleTrainerChange({ target: { value: opt.value } })
              }
            ...
            />
            {errors.coachId && (
              <span className="text-red-500 text-[11px]">{errors.coachId}</span>
            )}
          </div>
        </form>
      </div>
