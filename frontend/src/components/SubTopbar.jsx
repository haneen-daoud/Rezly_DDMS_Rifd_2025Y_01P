...
export default function SubTopbar({ onAddMemberClick, onAddBookingClick }) {
  ...
  return (
    <div className="w-full flex justify-between items-center rounded-lg  px-5 pt-4">
      {/* أقصى اليمين: التاريخ */}
      <div className="text-right font-cairo text-gray-700 text-sm">
        {formattedDate}
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="flex items-center gap-1 bg-green-500 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-green-600 transition">
