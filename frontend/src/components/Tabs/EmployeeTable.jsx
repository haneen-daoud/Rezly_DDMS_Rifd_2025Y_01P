...
export default function EmployeeTable({
  ...
  const handleSelectAll = () => {
    ...
    if (allSelected) {
      // إذا كانوا كلهم محددين → نفاضيهم
      setSelectedEmployees([]);
    } else {
      // إذا مش كلهم محددين → نحددهم كلهم
  ...
  const handleSelectEmployee = (id) => {
    ...
    if (selectedEmployees.includes(id)) {
      updatedSelected = selectedEmployees.filter((e) => e !== id);
    } else {
      updatedSelected = [...selectedEmployees, id];
    }

    setSelectedEmployees(updatedSelected);
    // ما في حاجة نضبط selectAll لأنها صارت محسوبة ديناميكياً من checked تبع تشيك بوكس الكل
  };
                      ...
                      <div
                        ...
                        style={{
                          backgroundColor:
                            ...
                            emp.contractType === "دوام كامل"
                              ? "#16B157"
                              : emp.contractType === "جزئي" ||
                                emp.contractType === "دوام جزئي"
                              ? "#2084DB"
                              : "#999999",
                        }}
                      >
